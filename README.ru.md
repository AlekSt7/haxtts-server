...
Так же имеется возможность добавлять или удалять собственные wav файлы с примерами голосов. Панель управления голосами доступна по http://your-address:9898/dashboard/index.html. Поддерживаются только .wav файлы.</br>
...
Docker контейнеру нужно около 6gb RAM для работы, так же <b>обязательно</b> нужен графический адаптер с VRAM не меньше 4gb (лично я тестировал на RTX3060).
...
```
По умолчанию: `8`</br>
Уменьшение этого значения, позволит сэкономить видеопамять, увеличение позволит сократить время синтеза <b>только на больших текстах</b>.
